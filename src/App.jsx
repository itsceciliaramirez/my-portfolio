  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-6">
        <h1 className="text-6xl font-bold mb-4">Cecilia Ramirez</h1>
        ...
        <div className="mt-8 flex gap-4">
          <a href="#projects" className="bg-white text-black px-6 py-3 rounded-xl font-semibold hover:bg-gray-300">
            View Projects
          </a>

          <a href="#contact" className="border border-white px-6 py-3 rounded-xl hover:bg-white hover:text-black">
            Contact Me
          </a>
        </div>
      </section>
      ...
      <section id="about" className="px-10 py-20 max-w-5xl mx-auto">
        ...
        <p className="text-gray-300 text-lg leading-8">
          ...
          real-world projects that solve problems. I enjoy working with data,
          creating dashboards, and developing applications that turn information
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="border border-gray-700 rounded-2xl p-6 hover:border-white transition">
            ...
            <p className="text-gray-300 mt-3">
              Analyzed housing data using Python, Pandas, and Tableau to identify
          ...
          <div className="border border-gray-700 rounded-2xl p-6 hover:border-white transition">
            <h3 className="text-2xl font-bold">Healthcare Analytics Platform</h3>

            <p className="text-gray-300 mt-3">
              Full-stack healthcare analytics platform built with React, Node.js,
              Express, PostgreSQL, SQL, Python, Tailwind CSS, REST APIs, and charts.
            </p>
          ...
          <div className="border border-gray-700 rounded-2xl p-6 hover:border-white transition">
            <h3 className="text-2xl font-bold">HealthConnect Database</h3>

            <p className="text-gray-300 mt-3">
              Database project focused on healthcare-related data management,
              SQL queries, tables, and relational database design.
            </p>
